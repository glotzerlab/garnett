...
echo "Creating environment for python 2.7"
conda create --yes -n glotzformats-py27 python=2.7 numpy cython
. activate glotzformats-py27
pip install git+ssh://git@github.com/glotzerlab/libgetar.git#egg=libgetar
python setup.py develop
. deactivate
echo "Done."

echo "Creating environment for python 3.3"
conda create --yes -n glotzformats-py33 python=3.3 numpy cython
...
echo "Creating environment for python 3.4"
conda create --yes -n glotzformats-py34 python=3.4 numpy cython
...
echo "Creating environment for python 3.5"
conda create --yes -n glotzformats-py35 python=3.5 numpy cython
