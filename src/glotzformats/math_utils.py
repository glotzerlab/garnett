...
def rotateVector(v,q):
    ...
    vrotq = quaternionMultiply(q, quaternionMultiply(vq,qc) ); #vrotq = q vq qc, vrotq as a quaternion (with 0 first comp)
    #vrotq = quaternionMultiply(quaternionMultiply(q,vq),qc)
