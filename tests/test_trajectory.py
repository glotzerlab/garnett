...
class TrajectoryTest(unittest.TestCase):
    ...
    def test_orientations(self):
        ...
        traj.load_arrays()
        try:
            if None not in traj.orientations:
    ...
    def test_velocities(self):
        ...
        traj.load_arrays()
        try:
            if None not in traj.velocities:
    ...
    def test_moment_inertia(self):
        ...
        traj.load_arrays()
        try:
            if None not in traj.moment_inertia:
